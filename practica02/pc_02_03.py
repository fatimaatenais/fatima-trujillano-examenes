...
def normalizar_telefonos(numeros, pais_defecto):
    codigos = {"PE" : "+51", "AR" : "+54", "CL" : "+56"}
    validos = []
    invalidos = ["NO VÁLIDOS"]

    if pais_defecto not in codigos:
        print("Prefijo no valido, porfavor ingrese un país válido")
        return {"válidos" : validos, "inválidos" : invalidos}
